...
\begin{figure*}[!t]
  ...
  reliably. The percentage of influenced vehicles goes to zero in several time
  steps in the highway scenario since the distances between vehicles are larger
  (in contrast to the urban scenario), and the neighbor vehicles do not need to
