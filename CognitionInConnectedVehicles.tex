...
\begin{figure*}[!t]
  ...
  reliably. Cognition framework can deal with sudden incidents more stably in
  urban scenario than highway since high speed vehicles create more dynamic
  environment conditions in highway scenarios.}
